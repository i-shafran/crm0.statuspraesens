 ...
 ************************************************************************************}
{strip}
    <div class="container-fluid" id="socialSettings">
	<div class="widget_header row-fluid">
		<div class="span8"><h3>{vtranslate('LBL_SPSOCIALCONNECTOR_SETTINGS', $QUALIFIED_MODULE)}</h3></div>
        {assign var=MODULE_MODEL value=Settings_SPSocialConnector_Module_Model::getCleanInstance()}
        <div class="span4"><div class="pull-right"><button class="btn editButton" data-url='{$MODULE_MODEL->getEditViewUrl()}&mode=showpopup' type="button" title="{vtranslate('LBL_EDIT', $QUALIFIED_MODULE)}"><strong>{vtranslate('LBL_EDIT', $QUALIFIED_MODULE)}</strong></button></div></div>
	</div>
	<hr>  
