                        ...
                        <div class="conditionList">
                           ...
                           {* \modules\CustomView\CustomView.php*}
                            <select id="criteria">
                                ...
                                <option value="k">Не содержит</option>
                                <option value="e">Равно</option>
                                <option value="n">Не равно</option>
                                <option value="s">Начинается с</option>
                                <option value="ew">Заканчивается на</option>
                            </select>
                            <input size="30" type="text" id="field_value" placeholder="Значение" />
                            <i style="margin-left: 20px" title="Удалить" class="icon-trash"></i>
                        </div>
                        <div class="addCondition">
                            <button type="button" class="btn"><strong>{vtranslate('LBL_ADD_CONDITION',$MODULE)}</strong></button>
                        </div>
                        <div style="margin-top: 10px">
                            <button id="go_filter" type="button" class="btn"><strong>Отфильтровать</strong></button>
                        </div>
                    </div>
                </div>
            </div>
