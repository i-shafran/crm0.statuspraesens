...
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e4509264763783e4c24bdcd38497b9da28516773' => 
    array (
      0 => '/www/3.dev.ept.ru/html/includes/runtime/../../layouts/vlayout/modules/Reports/Step1.tpl',
      1 => 1436794412,
      2 => 'file',
    ),
  ),
...
<span class="redColor">*</span></span><!-- SalesPlatform.ru begin --><span class="span7 row-fluid"><input class="span6" data-validation-engine='validate[required]' type="text" name="reportname" value="<?php echo vtranslate($_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('reportname'),$_smarty_tpl->tpl_vars['MODULE']->value);?>
"/></span><!-- <span class="span7 row-fluid"><input class="span6" data-validation-engine='validate[required]' type="text" name="reportname" value="<?php echo $_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('reportname');?>
"/></span> --><!-- SalesPlatform.ru end --></div><div class="row-fluid padding1per"><span class="span3"><?php echo vtranslate('LBL_REPORT_FOLDER',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</span><!-- SalesPlatform.ru begin --><span class="span7"><textarea class="span6" type="text" name="description" ><?php echo vtranslate($_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('description'),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</textarea></span><!-- <span class="span7"><textarea class="span6" type="text" name="description" ><?php echo $_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('description');?>
</textarea></span> --><!-- SalesPlatform.ru end --></div><div class="row-fluid padding1per"><div class="row span"><input type="checkbox"  <?php if ($_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('scheduleid')!=''){?> checked="" <?php }?> value="<?php if ($_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('scheduleid')!=''){?>true<?php }?>" name='enable_schedule' style="margin-top: 0px !important;"> &nbsp;<strong><?php echo vtranslate('LBL_SCHEDULE_REPORTS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<!-- SalesPlatform.ru begin --><span>&nbsp;(<?php echo vtranslate($_smarty_tpl->tpl_vars['ACTIVE_ADMIN']->value->time_zone,$_smarty_tpl->tpl_vars['MODULE']->value);?>
)</span><!-- <span>&nbsp;(<?php echo $_smarty_tpl->tpl_vars['ACTIVE_ADMIN']->value->time_zone;?>
)</span> --><!-- SalesPlatform.ru end --></div></div><?php }?></div></div><div class="pull-right"><button type="submit" class="btn btn-success nextStep"><strong><?php echo vtranslate('LBL_NEXT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
