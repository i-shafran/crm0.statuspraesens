<?php /* Smarty version Smarty-3.1.7, created on 2015-09-24 14:35:57
         compiled from "/www/3.dev.ept.ru/html/includes/runtime/../../layouts/vlayout/modules/Users/SystemSetup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:156150485603e01d923607-01052433%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aaf52fecbe9a4704a52f10c6d2d87b4feacd08a0' => 
    array (
      0 => '/www/3.dev.ept.ru/html/includes/runtime/../../layouts/vlayout/modules/Users/SystemSetup.tpl',
      1 => 1434383174,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '156150485603e01d923607-01052433',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5603e01d9eea2',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5603e01d9eea2')) {function content_5603e01d9eea2($_smarty_tpl) {?>
<html lang="en"><head><title><?php echo vtranslate('Vtiger CRM Setup','Install');?>
</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link REL="SHORTCUT ICON" HREF="layouts/vlayout/skins/images/favicon.ico"><link rel="stylesheet" href="libraries/bootstrap/css/bootstrap.css" type="text/css" media="screen" /><link rel="stylesheet" href="libraries/bootstrap/css/bootstrap-responsive.css" type="text/css" media="screen"><style type="text/css">
                    body{
                ...
                </script><div class="container-fluid page-container"><div class="row-fluid"><div class="span6"><div class="logo"><img src="test/logo/vtiger-crm-logo.png" alt="Vtiger Logo"/></div></div><div class="span6"></div></div><div class="row-fluid main-container"><div class="span12 inner-container"><div class="row-fluid"><div class="span8"><h3 style="display: inline-block;float:left;"> Какие возможности Vtiger CRM вы хотите использовать? </h3></div><div class="span4"><div class="pull-right"><label for="checkbox-1" style="vertical-align:bottom;margin:0;margin-top:8px\9;margin-left:10px\9;font-size:15px;"><strong> Выбрать все</strong></label> <input type="checkbox" name="selectAll" class="selectAll"/><div class="chkbox"></div></div></div></div><hr><form id="SystemSetup" class="form" method="POST" action="index.php?module=Users&action=SystemSetupSave"><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['PACKAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PACKAGE_INFO']->_loop = false;
...
?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==0||$_smarty_tpl->tpl_vars['COUNTER']->value%2==1){?><div class="row-fluid"><?php }?><div class="group-container <?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==0){?> span12 selectedContainer js-basePack <?php }else{ ?> span6 <?php }?>"><div class="module_list"><a> Список модулей </a></div><div class="row-fluid"><div class="<?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==0){?> span2 <?php }else{ ?> span3 <?php }?>"><img src="layouts/vlayout/skins/images/<?php echo $_smarty_tpl->tpl_vars['PACKAGE_INFO']->value['imageName'];?>
...
]" value="on"/><strong> This feature will be installed by default </strong></label>*}</div></div><?php }?><div class="reveal_modules"><div><strong>Для данной возможности будут включены следующие модули</strong><hr><div><?php $_smarty_tpl->tpl_vars['ITEMCOUNTER'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['MODULE_NAME'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['MODULE_NAME']->_loop = false;
...
</p><?php $_smarty_tpl->tpl_vars['ITEMCOUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['ITEMCOUNTER']->value+1, null, 0);?><?php if ($_smarty_tpl->tpl_vars['ITEMCOUNTER']->value==3){?><br><?php $_smarty_tpl->tpl_vars['ITEMCOUNTER'] = new Smarty_variable(0, null, 0);?><?php }?><?php } ?></div></div></div></div><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==0||$_smarty_tpl->tpl_vars['COUNTER']->value%2==1){?></div><?php }?><?php } ?><div class="row-fluid"><div class="span12"></div></div><div class="row-fluid"><div class="span9"><strong>Примечание: </strong> Позже вы можете включить/выключить модули через Менеджер модулей</div><div class="span3"><div class="button-container"><button type="submit" class="btn btn-large btn-primary next" value="Next"> Далее </button></div></div></div></form></div></div></div></body></html><?php }} ?>