<?php /* Smarty version Smarty-3.1.7, created on 2015-10-20 11:18:24
         compiled from "/www/3.dev.ept.ru/html/includes/runtime/../../layouts/vlayout/modules/Import/ImportAdvanced.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10295115045625f8d0b7eb49-73641067%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ee769dad4b2ef288da283454dd1371043c99e506' => 
    array (
      0 => '/www/3.dev.ept.ru/html/includes/runtime/../../layouts/vlayout/modules/Import/ImportAdvanced.tpl',
      1 => 1432833086,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10295115045625f8d0b7eb49-73641067',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5625f8d0c0aa9',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5625f8d0c0aa9')) {function content_5625f8d0c0aa9($_smarty_tpl) {?>
<div id="toggleButton" class="toggleButton" title="<?php echo vtranslate('LBL_LEFT_PANEL_SHOW_HIDE','Vtiger');?>
"><i id="tButtonImage" class="<?php if ($_smarty_tpl->tpl_vars['LEFTPANELHIDE']->value!='1'){?>icon-chevron-left<?php }else{ ?>icon-chevron-right<?php }?>"></i></div>&nbsp<div style="padding-left: 15px;"><form action="/rest_api/contacts/csv_import" enctype="multipart/form-data" method="POST" name="importAdvanced"><input type="hidden" name="module" value="<?php echo $_smarty_tpl->tpl_vars['FOR_MODULE']->value;?>
