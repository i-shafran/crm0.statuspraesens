...
<body class="small cwPageBg" topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
							...
							<table border=0 cellspacing=0 cellpadding=10 width=70% align=center>
								<tr>
									<td class=small align=left colspan=2>
										...
										<!-- <img src="include/install/images/welcome.gif" alt="<?php echo $installationStrings['LBL_WELCOME_CONFIG_WIZARD']; ?>" title="<?php echo $installationStrings['LBL_WELCOME_CONFIG_WIZARD']; ?>">-->
										<h1 style="color: #4572be">Добро пожаловать</h1>
										<h2 style="margin-bottom: 0px">в Мастер настройки VtigerCRM!</h2>
									    </td>
									    <td align=right valign=bottom>
										<a href="http://community.salesplatform.ru" target="_blank"><img border="0" src="themes/images/salesplatform.png" alt="SalesPlatform.ru" title="SalesPlatform.ru"></a>
									    </td>
									    </tr>
									    </table>										
	...
	<table border=0 cellspacing=0 cellpadding=0 width=80% align=center>
      	<tr>
        	<td class=small align=center> <a href="http://www.salesplatform.ru" target="_blank">www.salesplatform.ru</a></td>
      	</tr>
	</table>
</body>
</html>