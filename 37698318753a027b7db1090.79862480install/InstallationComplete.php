...
if(isset($application_unique_key) && !empty($application_unique_key)) {
	if(isset($disable_stats_tracking) && !empty($disable_stats_tracking)) {
		...
		$statimage = "<img src='http://stats.salesplatform.ru/stats.php?uid=$application_unique_key&v=$vtiger_current_version&type=I' 
				...
				<div style="width:100%;padding:10px;" align=left>
					...
					<ul>
						<li><?php echo $installationStrings['LBL_DOCUMENTATION_TEXT']; ?>
							<a href="http://community.salesplatform.ru/documentation" target="_blank">http://community.salesplatform.ru/documentation</a>
						</li>
						<li><?php echo $installationStrings['LBL_TUTORIAL_TEXT']; ?>
							<a href="http://community.salesplatform.ru/tutorials" target="_blank">http://community.salesplatform.ru/tutorials</a>
						</li>
					</ul>
					<br>
					...
					<ul><b>
						...
						<li><?php echo $installationStrings['LBL_DROP_A_MAIL']; ?>
							<a href="mailto:sales@salesplatform.ru" target="_blank">sales@salesplatform.ru</a>
						</li>
					</b></ul>
					<ul>
...
<table border=0 cellspacing=0 cellpadding=0 width=80% align=center>
	<tr>
		<td class=small align=center> <a href="http://salesplatform.ru" target="_blank">salesplatform.ru</a></td> | <?php echo $statimage ?>
	</tr>
</table>
</body>
</html>	