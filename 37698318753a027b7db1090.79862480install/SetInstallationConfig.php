...
!isset($_SESSION['config_file_info']['currency_name']) ? $currency_name = 'Russia, Rubles' : $currency_name = $_SESSION['config_file_info']['currency_name'];
										...
										<table width="100%" cellpadding="0"  cellspacing="1" border="0" align=center class="level3">
											...
											<tr>
												...
												<td width="75%" align="left"><input type="text" class="small" name="db_hostname" value="<?php if (isset($db_hostname)) echo "$db_hostname"; ?>" />
										   			&nbsp;<a href="http://community.salesplatform.ru/vtiger_links.php/help/<?php echo $vtiger_current_version; ?>/vtiger_CRM_Database_Hostname.pdf" target="_blank">More...</a></td>
											</tr>
											<tr>
