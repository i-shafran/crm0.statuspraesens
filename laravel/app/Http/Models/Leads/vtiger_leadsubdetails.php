...
class vtiger_leadsubdetails extends Model {
	 ...
	 * @var string
	 */
	protected $table = 'vtiger_leadsubdetails';
	 ...
	 * @var array
	 */
	protected $guarded = array('leadsubscriptionid');
	 ...
	 * @var string
	 */
	protected $primaryKey = 'leadsubscriptionid';
