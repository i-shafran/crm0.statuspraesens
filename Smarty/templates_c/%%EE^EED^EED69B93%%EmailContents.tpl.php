<?php /* Smarty version 2.6.18, created on 2014-08-20 17:20:09
...
"  class="crmbutton small delete" onClick="return massDelete();"/>
		...
		<td width="20%" align=left class="small">
			<select name="search_field" id="search_field"    class="importBox">
				...
				<option value='user_name'><?php echo $this->_tpl_vars['MOD']['LBL_IN_SENDER']; ?>
                                				...
                                				<option value='to_email'><?php echo $this->_tpl_vars['MOD']['LBL_IN_RECIPIENT']; ?>
</option>
		...
		<td width="10%">
                        			<input name="find" value=" <?php echo getTranslatedString('LBL_FIND', $this->_tpl_vars['MODULE']); ?>
 " class="crmbutton small create" onclick="Searchfn();" type="button">
			                        		</td>
