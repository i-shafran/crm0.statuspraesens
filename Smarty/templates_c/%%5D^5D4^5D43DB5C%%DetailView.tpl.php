<?php /* Smarty version 2.6.18, created on 2014-08-16 01:05:05
         compiled from DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtlib_purify', 'DetailView.tpl', 26, false),array('modifier', 'getTranslatedString', 'DetailView.tpl', 51, false),array('modifier', 'vtiger_imageurl', 'DetailView.tpl', 196, false),array('modifier', 'count', 'DetailView.tpl', 221, false),array('modifier', 'replace', 'DetailView.tpl', 324, false),)), $this); ?>
		...
		if(anchorImgId !=null){
			eval(document.getElementById(anchorImgId)).src =  \'themes/images/inactivate.gif\';
                '; ?>
                        ...
                        eval(document.getElementById(anchorImgId)).alt = '<?php echo getTranslatedString('Display'); ?>
';
                        eval(document.getElementById(anchorImgId)).title = '<?php echo getTranslatedString('Display'); ?>
';
                <?php echo '
                }
	}
	else
	{
		...
		if(anchorImgId !=null){
                '; ?>
                    ...
                    eval(document.getElementById(anchorImgId)).alt = '<?php echo getTranslatedString('Hide'); ?>
';
                    eval(document.getElementById(anchorImgId)).title = '<?php echo getTranslatedString('Hide'); ?>
';
                <?php echo '
                }
	}
...
&createmode=link"><img src="<?php echo vtiger_imageurl('actionGenerateInvoice.gif', $this->_tpl_vars['THEME']); ?>
" hspace="5" align="absmiddle"  border="0"/></a>
																	<a class="webMnu" href="index.php?return_module=<?php echo $this->_tpl_vars['MODULE']; ?>
&return_action=DetailView&return_id=<?php echo $this->_tpl_vars['ID']; ?>
&convertmode=<?php echo $this->_tpl_vars['CONVERTMODE']; ?>
&module=Invoice&action=EditView&account_id=<?php echo $this->_tpl_vars['ACCOUNTID']; ?>
&createmode=link"><?php echo $this->_tpl_vars['APP']['LBL_CREATE']; ?>
...
; sendfile_email();"><?php echo $this->_tpl_vars['MOD']['LBL_EMAIL_FILE']; ?>
				...
				<!-- Start: Actions for PDF Templates -->
                                <?php if ($this->_tpl_vars['PDF_TEMPLATES_LIST'] && ( $this->_tpl_vars['MODULE'] == 'HelpDesk' || $this->_tpl_vars['MODULE'] == 'Potentials' || $this->_tpl_vars['MODULE'] == 'SPPayments' )): ?>
                                   <tr>
                                        <td align="left">
...
','HelpDesk');
	<?php endif; ?>
	<?php if ($this->_tpl_vars['MODULE'] == 'Potentials'): ?>
		OpenCompose('<?php echo $this->_tpl_vars['ID']; ?>
','Potentials');
	<?php endif; ?>
	<?php if ($this->_tpl_vars['MODULE'] == 'SPPayments'): ?>
		OpenCompose('<?php echo $this->_tpl_vars['PAYMENT_NO']; ?>
','Payment');
	<?php endif; ?>
<?php echo '
}
