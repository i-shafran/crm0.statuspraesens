<?php /* Smarty version 2.6.18, created on 2014-08-16 01:04:58
         compiled from ListView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ListView.tpl', 200, false),array('modifier', 'getTranslatedString', 'ListView.tpl', 302, false),array('modifier', 'in_array', 'ListView.tpl', 409, false),array('function', 'html_options', 'ListView.tpl', 234, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['smartfilterExists']): ?>
<table style="margin-top:5px; border:1px solid #dedede;" cellspacing=0 align="center">
<tr>   
<?php $_from = $this->_tpl_vars['spFilterTplArr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['dataArr']):
?>
    
	
<?php if ($this->_tpl_vars['dataArr'][2] == 'N' || $this->_tpl_vars['dataArr'][2] == 'NN' || $this->_tpl_vars['dataArr'][2] == 'I'): ?>
  <td style="border-right:1px solid #dedede;"> 
    <table>
     <tr>
       <td style="padding-left:5px" align=left><?php echo getTranslatedString($this->_tpl_vars['dataArr'][4], $this->_tpl_vars['dataArr'][4]); ?>
:</td>
       <td style="padding-left:3px" align=left><?php echo getTranslatedString('LBL_FROM_VALUE', 'LBL_FROM_VALUE'); ?>
</td>
       <td style="padding-left:3px" class="small"><input type="text" name="<?php echo $this->_tpl_vars['dataArr'][0]; ?>
_from" id="<?php echo $this->_tpl_vars['dataArr'][0]; ?>
_from" style="width:70px" class="txtBox"></td>
       <td style="padding-left:5px" align=left><?php echo getTranslatedString('LBL_TO_VALUE', 'LBL_TO_VALUE'); ?>
</td>
       <td style="padding-left:5px" class="small"><input  type="text" name="<?php echo $this->_tpl_vars['dataArr'][0]; ?>
_to" id="<?php echo $this->_tpl_vars['dataArr'][0]; ?>
_to" style="width:70px" class="txtBox"></td>
     </tr>
    </table>
   </td>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['dataArr'][1] == 23 || $this->_tpl_vars['dataArr'][1] == 5 || $this->_tpl_vars['dataArr'][1] == 6 || $this->_tpl_vars['dataArr'][1] == 30 || $this->_tpl_vars['dataArr'][1] == 64 || $this->_tpl_vars['dataArr'][1] == 70): ?>
  <td style="border-right:1px solid #dedede;"> 
    <table>
     <tr>
       <td style="padding-left:5px" align=left><?php echo getTranslatedString($this->_tpl_vars['dataArr'][4], $this->_tpl_vars['dataArr'][4]); ?>
:</td>
       <td style="padding-left:3px; padding-bottom:10px;" align=left><?php echo getTranslatedString('LBL_FROM_VALUE', 'LBL_FROM_VALUE'); ?>
</td>
       <td style="padding-left:3px" class="small">
           
           <input name="from<?php echo $this->_tpl_vars['dataArr'][0]; ?>
" tabindex="" id="jscal_field_from<?php echo $this->_tpl_vars['dataArr'][0]; ?>
" type="text" style="width:60px" class="txtBox">
      
           <?php if ($this->_tpl_vars['uitype'] == 6): ?>
	         <input name="time_start" tabindex="" style="width:60px" class="txtBox" type="text">
           <?php endif; ?>
				
           <?php if ($this->_tpl_vars['uitype'] == 6 && $this->_tpl_vars['dataArr'][8] == 'Event'): ?>
	         <input name="dateFormat" type="hidden">
           <?php endif; ?>

           <?php if ($this->_tpl_vars['uitype'] == 23 && $this->_tpl_vars['dataArr'][8] == 'Event'): ?>
	         <input name="time_end" style="width:60px" class="txtBox" type="text">
           <?php endif; ?>
           
           <?php if ($this->_tpl_vars['uitype'] == 5 || $this->_tpl_vars['uitype'] == 23): ?>
	         <br><font size=1><em old="(yyyy-mm-dd)">(<?php echo $this->_tpl_vars['dataArr'][7]; ?>
)</em></font></br>
           <?php else: ?>
	         <br><font size=1><em old="(yyyy-mm-dd)">(<?php echo $this->_tpl_vars['dataArr'][7]; ?>
)</em></font></br>
       ...
       <td style="padding-left:3px" class="small">
           <img style="vertical-align: bottom;" src="<?php echo vtiger_imageurl('btnL3Calendar.gif', $this->_tpl_vars['THEME']); ?>
" id="jscal_trigger_from<?php echo $this->_tpl_vars['dataArr'][0]; ?>
">

           <script type="text/javascript" id='massedit_calendar_from<?php echo $this->_tpl_vars['dataArr'][0]; ?>
'>
	         Calendar.setup ({
			             inputField : "jscal_field_from<?php echo $this->_tpl_vars['dataArr'][0]; ?>
", ifFormat : "<?php echo $this->_tpl_vars['dataArr'][6]; ?>
", showsTime : false, button : "jscal_trigger_from<?php echo $this->_tpl_vars['dataArr'][0]; ?>
", singleClick : true, step : 1
			         })
           </script>
       </td>
       <td style="padding-left:5px; padding-bottom:10px;" align=left><?php echo getTranslatedString('LBL_TO_VALUE', 'LBL_TO_VALUE'); ?>
</td>
       <td style="padding-left:5px" class="small">
           <input name="to<?php echo $this->_tpl_vars['dataArr'][0]; ?>
" tabindex="" id="jscal_field_to<?php echo $this->_tpl_vars['dataArr'][0]; ?>
" type="text" style="width:60px" class="txtBox">
       ...
       <td style="padding-left:3px" class="small">
           <img style="vertical-align: bottom;" src="<?php echo vtiger_imageurl('btnL3Calendar.gif', $this->_tpl_vars['THEME']); ?>
" id="jscal_trigger_to<?php echo $this->_tpl_vars['dataArr'][0]; ?>
">
           
           <script type="text/javascript" id='massedit_calendar_to<?php echo $this->_tpl_vars['dataArr'][0]; ?>
'>
	         Calendar.setup ({
			             inputField : "jscal_field_to<?php echo $this->_tpl_vars['dataArr'][0]; ?>
", ifFormat : "<?php echo $this->_tpl_vars['dataArr'][6]; ?>
", showsTime : false, button : "jscal_trigger_to<?php echo $this->_tpl_vars['dataArr'][0]; ?>
", singleClick : true, step : 1
			         })
           </script>
       </td>
...
<?php if ($this->_tpl_vars['dataArr'][2] == 'C' || $this->_tpl_vars['dataArr'][1] == 56): ?>
  <td style="border-right:1px solid #dedede;"> 
  <table>
   <tr>  
    <td style="padding-left:5px" align=left><?php echo getTranslatedString($this->_tpl_vars['dataArr'][4], $this->_tpl_vars['dataArr'][4]); ?>
:</td>
    <td align=left >       
        <select id="<?php echo $this->_tpl_vars['dataArr'][0]; ?>
" name="<?php echo $this->_tpl_vars['dataArr'][0]; ?>
" tabindex="" class="small">
	     <option value=""></option>
             <option value="yes">
                <?php echo getTranslatedString('yes', 'yes'); ?>

             </option>	
             <option value="no">
                <?php echo getTranslatedString('no', 'no'); ?>
...
<?php if (( $this->_tpl_vars['dataArr'][2] == 'V' || $this->_tpl_vars['dataArr'][2] == 'E' ) && ! in_array($this->_tpl_vars['dataArr'][1], $this->_tpl_vars['spUiTypesListTplArr'][0]) && ! in_array($this->_tpl_vars['dataArr'][1], $this->_tpl_vars['spUiTypesListTplArr'][1]) && $this->_tpl_vars['dataArr'][1] != 56): ?>
  <td style="border-right:1px solid #dedede;"> 
    <table>
     <tr>
       <td style="padding-left:5px" align=left><?php echo getTranslatedString($this->_tpl_vars['dataArr'][4], $this->_tpl_vars['dataArr'][4]); ?>
:</td>
       <td style="padding-left:3px" class="small"><input type="text" name="<?php echo $this->_tpl_vars['dataArr'][0]; ?>
" id="<?php echo $this->_tpl_vars['dataArr'][0]; ?>
" style="width:70px" class="txtBox"></td>
     </tr>
    </table>
   </td>
<?php endif; ?>

<?php if (in_array($this->_tpl_vars['dataArr'][1], $this->_tpl_vars['spUiTypesListTplArr'][0])): ?>
 <td style="border-right:1px solid #dedede;"> 
  <table>
   <tr>  
    <td style="padding-left:5px" align=left><?php echo getTranslatedString($this->_tpl_vars['dataArr'][4], $this->_tpl_vars['dataArr'][4]); ?>
...
" tabindex="" class="small">
	     <option value=""></option>
             <?php $_from = $this->_tpl_vars['dataArr'][3]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['listitem']):
?>
		     <option value="<?php echo $this->_tpl_vars['listitem']; ?>
">
                             <?php echo getTranslatedString($this->_tpl_vars['listitem'], $this->_tpl_vars['listitem']); ?>
...
<td style="padding-left:10px; padding-right:10px;" align=left><input name="submit" type="button" class="crmbutton small create" onClick="sp_smartfilter('<?php echo $this->_tpl_vars['MODULE']; ?>
','<?php echo $this->_tpl_vars['spFilterJsStr']; ?>
','<?php echo $this->_tpl_vars['spUiTypesListJsStr']; ?>
');" value=" <?php echo $this->_tpl_vars['APP']['LBL_BUTTON_FILTER']; ?>
 "></td>
</tr>
</table>
<?php endif; ?>
