...
">
        ...
        <input type="hidden" name="entity_id">
        <input type="hidden" name="pdf_template">
<?php elseif ($this->_tpl_vars['MODULE'] == 'PurchaseOrder' || $this->_tpl_vars['MODULE'] == 'SalesOrder' || $this->_tpl_vars['MODULE'] == 'Invoice' || $this->_tpl_vars['MODULE'] == 'Act' || $this->_tpl_vars['MODULE'] == 'Consignment'): ?>
	<input type="hidden" name="module" value="<?php echo $this->_tpl_vars['MODULE']; ?>
">
        <input type="hidden" name="record" value="<?php echo $this->_tpl_vars['ID']; ?>
">
        ...
        <input type="hidden" name="source_module">
        <input type="hidden" name="entity_id">
	<?php if ($this->_tpl_vars['MODULE'] == 'SalesOrder' || $this->_tpl_vars['MODULE'] == 'Invoice'): ?>
        	<input type="hidden" name="convertmode">
	<?php endif; ?>
        <input type="hidden" name="pdf_template">
