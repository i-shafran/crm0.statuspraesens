<?php /* Smarty version 2.6.18, created on 2014-08-18 11:11:33
...
'" type="submit" name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
  " style="width:70px" >
                                                                                        ...
                                                                                        <input title="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
" class="crmbutton small save" onclick="this.form.action.value='Save'; displaydeleted();  if(formValidate()) sp_js_editview_checkBeforeSave('<?php echo $this->_tpl_vars['MODULE']; ?>
',this.form, '<?php echo $this->_tpl_vars['MODE']; ?>
');"  type="button" name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
  " style="width:70px" >
                                                                                        ...
                                                                                        <input title="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
" class="crmbutton small save" onclick="this.form.action.value='Save';  if(formValidate()) sp_js_editview_checkBeforeSave('<?php echo $this->_tpl_vars['MODULE']; ?>
',this.form, '<?php echo $this->_tpl_vars['MODE']; ?>
');" type="button" name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
  " style="width:70px" >
...
" class="crmbutton small cancel" onclick="window.history.back()" type="button" name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
  " style="width:70px">
                                                                           ...
                                                                           <?php if ($this->_tpl_vars['FL_IMPORT_BUTTON'] && ( $this->_tpl_vars['MODULE'] == 'Leads' || $this->_tpl_vars['MODULE'] == 'Accounts' || $this->_tpl_vars['MODULE'] == 'Contacts' )): ?>
                                                                               <tr>
                                                                                   <td  colspan=4 style="padding-bottom:5px"align="right">
                                                                                        <input title="<?php echo $this->_tpl_vars['APP']['LBL_IMPORT_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_IMPORT_BUTTON_KEY']; ?>
" class="crmButton small create" onclick="SPSocialConnectorCommon.displayEnterUrlWizard('<?php echo $this->_tpl_vars['MODULE']; ?>
', '<?php echo $this->_tpl_vars['ID']; ?>
');" type="button" name="button" value="   <?php echo $this->_tpl_vars['APP']['LBL_IMPORT_BUTTON_LABEL']; ?>
   " style="width:70px" >
                                                                                   </td>
                                                                               </tr>
                                                                           <?php endif; ?>
...
?>
							...
							<?php endif; ?>
									      ...
									      <tr>
										<?php if ($this->_tpl_vars['header'] == $this->_tpl_vars['MOD']['LBL_ADDRESS_INFORMATION'] && ( $this->_tpl_vars['MODULE'] == 'Accounts' || $this->_tpl_vars['MODULE'] == 'Quotes' || $this->_tpl_vars['MODULE'] == 'PurchaseOrder' || $this->_tpl_vars['MODULE'] == 'SalesOrder' || $this->_tpl_vars['MODULE'] == 'Invoice' || $this->_tpl_vars['MODULE'] == 'Act' || $this->_tpl_vars['MODULE'] == 'Consignment' )): ?>
...
unset($_smarty_tpl_vars);
 ?>
									   ...
									   <?php if ($this->_tpl_vars['MODULE'] == 'PurchaseOrder' || $this->_tpl_vars['MODULE'] == 'SalesOrder' || $this->_tpl_vars['MODULE'] == 'Quotes' || $this->_tpl_vars['MODULE'] == 'Invoice' || $this->_tpl_vars['MODULE'] == 'Act' || $this->_tpl_vars['MODULE'] == 'Consignment'): ?>
							   		   <tr>
										<td colspan=4>
											<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<script>	
        ...
        var crmId;
        <?php if (isset ( $this->_tpl_vars['ID'] ) && ! empty ( $this->_tpl_vars['ID'] )): ?>
