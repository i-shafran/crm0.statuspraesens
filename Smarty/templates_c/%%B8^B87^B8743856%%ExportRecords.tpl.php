<?php /* Smarty version 2.6.18, created on 2014-08-19 18:47:19
         compiled from ExportRecords.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ExportRecords.tpl', 20, false),array('modifier', 'getTranslatedString', 'ExportRecords.tpl', 119, false),)), $this); ?>
										...
										<table >
											<tr>		
												<td><div id="not_search" style="position:absolute;display:none;width:400px;height:25px;"></div></td>
                                                                    ...
                                                                    <b><?php echo getTranslatedString('LBL_DELIMITER', 'Import'); ?>
</b>&nbsp;
                                                                            <select name="delimiter" class="small" style="font-family:Times;">
                                                                                    <option value=";" selected>;</option>
                                                                                    <option value=",">,</option>
                                                                            </select>
                                                                    <b><?php echo getTranslatedString('LBL_CHARACTER_ENCODING', 'Import'); ?>
</b>&nbsp;
