...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtlib_purify', 'EditViewHidden.tpl', 93, false),)), $this); ?>
...
<?php elseif ($this->_tpl_vars['MODULE'] == 'PurchaseOrder' || $this->_tpl_vars['MODULE'] == 'SalesOrder' || $this->_tpl_vars['MODULE'] == 'Invoice' || $this->_tpl_vars['MODULE'] == 'Quotes' || $this->_tpl_vars['MODULE'] == 'Act' || $this->_tpl_vars['MODULE'] == 'Consignment'): ?>
...
"/>
	...
	<?php if ($this->_tpl_vars['MODULE'] == 'Invoice' || $this->_tpl_vars['MODULE'] == 'PurchaseOrder' || $this->_tpl_vars['MODULE'] == 'SalesOrder' || $this->_tpl_vars['MODULE'] == 'Act' || $this->_tpl_vars['MODULE'] == 'Consignment'): ?>
