<?php /* Smarty version 2.6.18, created on 2014-08-18 11:11:34
         compiled from EditViewUI.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'EditViewUI.tpl', 34, false),array('modifier', 'getTranslatedString', 'EditViewUI.tpl', 61, false),array('modifier', 'getTranslatedCurrencyString', 'EditViewUI.tpl', 440, false),array('modifier', 'substr', 'EditViewUI.tpl', 497, false),)), $this); ?>
...
_display.value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
                        ...
                        <style>.ui-autocomplete-loading { background: white url('<?php echo vtiger_imageurl('vtbusy.gif', $this->_tpl_vars['THEME']); ?>
') right center no-repeat; }</style>
                        <script>
                            newJQuery(function() {
                                    var cache = {}, lastXhr;
                                    newJQuery( "#<?php echo $this->_tpl_vars['fldname']; ?>
" ).autocomplete({
                                            minLength: 2,
                                            source: function( request, response ) {
                                                ...
                                                lastXhr = newJQuery.getJSON( "index.php?module=SPModulePickList&action=SPModulePickListAjax&type=GetValues&fieldname=<?php echo $this->_tpl_vars['fldname']; ?>
", request, function( data, status, xhr ) {
			...
			<td width=20% class="dvtCellLabel" align=right>
				<font color="red"><?php echo $this->_tpl_vars['mandatory_field']; ?>
</font><font color="green">*</font><?php echo $this->_tpl_vars['usefldlabel']; ?>
 <?php if ($this->_tpl_vars['MASS_EDIT'] == '1'): ?><input type="checkbox" name="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" id="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" class="small"><?php endif; ?>
			</td>
...
" id="<?php echo $this->_tpl_vars['fldname']; ?>
" />
                                        &nbsp;<img title="<?php echo $this->_tpl_vars['APP']['LBL_CHANGE_TITLE']; ?>
" src="<?php echo vtiger_imageurl('select.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CHANGE']; ?>
" class="small" name=btn1 align="absmiddle" LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&html=Popup_picker&form=vtlibPopupView&form_submit=false&fromlink=<?php echo $this->_tpl_vars['fromlink']; ?>
&recordid=<?php echo $this->_tpl_vars['ID']; ?>
&forfield=<?php echo $this->_tpl_vars['fldname']; ?>
","test","width=640,height=603,resizable=0,scrollbars=0");' style='cursor:hand;cursor:pointer'>
	            	&nbsp;<input type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
