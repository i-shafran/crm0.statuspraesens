...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'DetailViewUI.tpl', 45, false),array('modifier', 'vtiger_imageurl', 'DetailViewUI.tpl', 57, false),array('modifier', 'getTranslatedCurrencyString', 'DetailViewUI.tpl', 68, false),array('modifier', 'cat', 'DetailViewUI.tpl', 140, false),array('modifier', 'replace', 'DetailViewUI.tpl', 145, false),array('modifier', 'wordwrap', 'DetailViewUI.tpl', 147, false),array('modifier', 'regex_replace', 'DetailViewUI.tpl', 228, false),array('modifier', 'parse_calendardate', 'DetailViewUI.tpl', 435, false),)), $this); ?>
...
" onclick="sp_js_detailview_checkBeforeSave('<?php echo $this->_tpl_vars['label']; ?>
...
')" class="link"><?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
			...
			<?php else: ?>
											<td width=25% class="dvtCellInfo" align="left"><?php if ($this->_tpl_vars['APP'][$this->_tpl_vars['keyval']] != ''): ?><?php echo $this->_tpl_vars['APP'][$this->_tpl_vars['keyval']]; ?>
<?php elseif ($this->_tpl_vars['MOD'][$this->_tpl_vars['keyval']] != ''): ?><?php echo $this->_tpl_vars['MOD'][$this->_tpl_vars['keyval']]; ?>
<?php else: ?><?php echo $this->_tpl_vars['keyval']; ?>
<?php endif; ?>&nbsp;
			<?php endif; ?>
