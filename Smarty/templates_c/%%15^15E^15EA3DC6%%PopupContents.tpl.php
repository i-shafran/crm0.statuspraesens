<?php /* Smarty version 2.6.18, created on 2014-08-21 12:57:10
         compiled from PopupContents.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'PopupContents.tpl', 19, false),array('modifier', 'vtiger_imageurl', 'PopupContents.tpl', 82, false),)), $this); ?>
<!-- BEGIN: main -->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="small">
	...
	<?php if ($this->_tpl_vars['SELECT'] == 'enable' && ( $this->_tpl_vars['POPUPTYPE'] != 'inventory_prod' && $this->_tpl_vars['POPUPTYPE'] != 'inventory_prod_po' && $this->_tpl_vars['POPUPTYPE'] != 'inventory_service' )): ?>
            <?php if ($this->_tpl_vars['MODULE'] == 'Calendar' && $this->_tpl_vars['RETURN_MODULE'] == 'Contacts'): ?>
...
" onclick="if(SelectAllRL('<?php echo $this->_tpl_vars['MODULE']; ?>
...
">
                        ...
                        <table border="0" cellpadding="5" cellspacing="0" width="98%">
                                <tr>
                                                                                ...
                                                                                <td rowspan="2" width="25%"><img src="<?php echo vtiger_imageurl('plsWaitAnimated.gif', $this->_tpl_vars['THEME']); ?>
"></td>
