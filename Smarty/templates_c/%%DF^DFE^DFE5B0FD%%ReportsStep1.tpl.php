<?php /* Smarty version 2.6.18, created on 2014-08-16 01:06:45
		...
		<td>
					...
					<td width="25%" valign="top">
						<table width="100%" border="0" cellpadding="5" cellspacing="0" class="small">
                                                                                                                <?php if ($this->_tpl_vars['SP_CUSTOM_REPORT'] == 'true'): ?>
							<tr><td id="step6label" class="settingsTabList" style="padding-left:10px;">1. <?php echo $this->_tpl_vars['MOD']['LBL_SHARING']; ?>
 </td></tr>
							<tr><td id="step7label" class="settingsTabList" style="padding-left:10px;">2. <?php echo $this->_tpl_vars['MOD']['LBL_SCHEDULE_EMAIL']; ?>
 </td></tr>
                                                        <?php else: ?>
...
&nbsp; " class="crmbutton small cancel" onClick="changeStepsback1();" disabled>&nbsp;
                                                <?php else: ?>
                                                						<input type="button" id="back_rep" name="back_rep" value=" &nbsp;&lt;&nbsp;<?php echo $this->_tpl_vars['APP']['LBL_BACK']; ?>
