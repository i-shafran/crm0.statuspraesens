<?php /* Smarty version 2.6.18, created on 2014-08-19 15:35:07
         compiled from Inventory/InventoryActions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtlib_isModuleActive', 'Inventory/InventoryActions.tpl', 36, false),array('modifier', 'vtiger_imageurl', 'Inventory/InventoryActions.tpl', 40, false),array('modifier', 'getTranslatedString', 'Inventory/InventoryActions.tpl', 208, false),)), $this); ?>
   ...
   <!-- This if condition is added to avoid display Tools heading because now there is no options in Tools. -->
	...
	<?php if ($this->_tpl_vars['MODULE'] == 'Products' || $this->_tpl_vars['MODULE'] == 'Services'): ?>
	   <!-- Product/Services Actions starts -->
		...
		<?php endif; ?>
	              <?php if (vtlib_isModuleActive('Quotes')): ?>
                      <tr>
...
'; document.DetailView.record.value=''; document.DetailView.submit();" class="webMnu"><?php echo $this->_tpl_vars['APP']['LBL_CREATE_BUTTON_LABEL']; ?>
 <?php echo $this->_tpl_vars['APP']['Quote']; ?>
	              ...
	              <?php endif; ?>
           <?php if (vtlib_isModuleActive('Invoice')): ?>
           	   <tr>
		<td align="left" style="padding-left:5px;">
...
'; document.DetailView.record.value=''; document.DetailView.submit();" class="webMnu"><?php echo $this->_tpl_vars['APP']['LBL_CREATE_BUTTON_LABEL']; ?>
 <?php echo $this->_tpl_vars['APP']['Invoice']; ?>
	              ...
	              <?php endif; ?>
           <?php if (vtlib_isModuleActive('SalesOrder')): ?>
           	   <tr>
		<td align="left" style="padding-left:5px;">
...
'; document.DetailView.record.value=''; document.DetailView.submit();" class="webMnu"><?php echo $this->_tpl_vars['APP']['LBL_CREATE_BUTTON_LABEL']; ?>
 <?php echo $this->_tpl_vars['APP']['SalesOrder']; ?>
	              ...
	              <?php endif; ?>
           <?php if (vtlib_isModuleActive('PurchaseOrder')): ?>
           	   <tr>
		<td align="left" style="padding-left:5px;">
...
'; document.DetailView.convertmode.value='sotoinvoice'; document.DetailView.submit();" class="webMnu"><img src="<?php echo vtiger_imageurl('actionGenPurchaseOrder.gif', $this->_tpl_vars['THEME']); ?>
" hspace="5" align="absmiddle" border="0"/></a>
                                                			<a href="javascript: document.DetailView.module.value='Invoice'; document.DetailView.action.value='EditView'; document.DetailView.return_module.value='SalesOrder'; document.DetailView.return_action.value='DetailView'; document.DetailView.return_id.value='<?php echo $this->_tpl_vars['ID']; ?>
'; document.DetailView.record.value='<?php echo $this->_tpl_vars['ID']; ?>
...
" hspace="5" align="absmiddle"/>
	   ...
	   -->
           <?php if (vtlib_isModuleActive('Act')): ?>
	   <tr>
		<td align="left" style="padding-left:10px;">
<a href="javascript: document.DetailView.return_module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
'; document.DetailView.return_action.value='DetailView'; document.DetailView.convertmode.value='invoicetoact'; document.DetailView.module.value='Act'; document.DetailView.action.value='EditView'; document.DetailView.return_id.value='<?php echo $this->_tpl_vars['ID']; ?>
'; document.DetailView.submit();" class="webMnu"><img src="<?php echo vtiger_imageurl('actionGenerateQuote.gif', $this->_tpl_vars['THEME']); ?>
" hspace="5" align="absmiddle" border="0"/></a>
		<a href="javascript: document.DetailView.return_module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
'; document.DetailView.return_action.value='DetailView'; document.DetailView.convertmode.value='invoicetoact'; document.DetailView.module.value='Act'; document.DetailView.action.value='EditView'; document.DetailView.return_id.value='<?php echo $this->_tpl_vars['ID']; ?>
'; document.DetailView.submit();" class="webMnu"><?php echo $this->_tpl_vars['APP']['LBL_GENERATE']; ?>
 <?php echo $this->_tpl_vars['APP']['Act']; ?>
</a>
		</td>
	   </tr>
           <?php endif; ?>
           <?php if (vtlib_isModuleActive('Consignment')): ?>
	   <tr>
		<td align="left" style="padding-left:10px;">
<a href="javascript: document.DetailView.return_module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
'; document.DetailView.return_action.value='DetailView'; document.DetailView.convertmode.value='invoicetoconsignment'; document.DetailView.module.value='Consignment'; document.DetailView.action.value='EditView'; document.DetailView.return_id.value='<?php echo $this->_tpl_vars['ID']; ?>
'; document.DetailView.submit();" class="webMnu"><img src="<?php echo vtiger_imageurl('actionGenerateSalesOrder.gif', $this->_tpl_vars['THEME']); ?>
" hspace="5" align="absmiddle" border="0"/></a>
		<a href="javascript: document.DetailView.return_module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
'; document.DetailView.return_action.value='DetailView'; document.DetailView.convertmode.value='invoicetoconsignment'; document.DetailView.module.value='Consignment'; document.DetailView.action.value='EditView'; document.DetailView.return_id.value='<?php echo $this->_tpl_vars['ID']; ?>
'; document.DetailView.submit();" class="webMnu"><?php echo $this->_tpl_vars['APP']['LBL_GENERATE']; ?>
 <?php echo $this->_tpl_vars['APP']['Consignment']; ?>
</a>
		</td>
	   </tr>
           <?php endif; ?>
...
<?php if ($this->_tpl_vars['MODULE'] != 'Products' && $this->_tpl_vars['MODULE'] != 'Services' && $this->_tpl_vars['MODULE'] != 'Vendors' && $this->_tpl_vars['MODULE'] != 'PriceBooks'): ?>
   ...
   <tr>
	<td align="left">
		<span class="genHeaderSmall"><?php echo $this->_tpl_vars['APP']['PrintingOptions']; ?>
</span><br /> 
	</td>
   </tr>
...
<?php if ($this->_tpl_vars['MODULE'] == 'SalesOrder' || $this->_tpl_vars['MODULE'] == 'Quotes' || $this->_tpl_vars['MODULE'] == 'Invoice' || $this->_tpl_vars['MODULE'] == 'Act' || $this->_tpl_vars['MODULE'] == 'Consignment' || $this->_tpl_vars['MODULE'] == 'PurchaseOrder'): ?>
   ...
   <tr>
	...
	<form action="" name="PrintSettings" id="form">
		...
		<?php echo $this->_tpl_vars['PDF_TEMPLATES_LIST']; ?>
   ...
   <tr>
	<td align="left" style="padding-left:10px;">
		<a href="javascript: generatepdf_send('index.php?module=<?php echo $this->_tpl_vars['MODULE']; ?>
...
'; document.DetailView.pdf_template.value=document.PrintSettings.pdf_templates.value; sendpdf_submit();" class="webMnu"><img src="<?php echo vtiger_imageurl('PDFMail.gif', $this->_tpl_vars['THEME']); ?>
" hspace="5" align="absmiddle" border="0"/></a>
		<a href="javascript: document.DetailView.return_module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
'; document.DetailView.return_action.value='DetailView'; document.DetailView.module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
'; document.DetailView.action.value='SendPDFMail'; document.DetailView.record.value='<?php echo $this->_tpl_vars['ID']; ?>
'; document.DetailView.return_id.value='<?php echo $this->_tpl_vars['ID']; ?>
'; document.DetailView.pdf_template.value=document.PrintSettings.pdf_templates.value; sendpdf_submit();" class="webMnu"><?php echo $this->_tpl_vars['APP']['LBL_SEND_EMAIL_PDF']; ?>
</a> 
	</td>
   </tr>
<?php endif; ?>
...
','SalesOrder');
	<?php elseif ($this->_tpl_vars['MODULE'] == 'Act'): ?>
		OpenCompose('<?php echo $this->_tpl_vars['ACT_NO']; ?>
','Act');
	<?php elseif ($this->_tpl_vars['MODULE'] == 'Consignment'): ?>
		OpenCompose('<?php echo $this->_tpl_vars['CONSIGNMENT_NO']; ?>
','Consignment');
	<?php elseif ($this->_tpl_vars['MODULE'] == 'PurchaseOrder'): ?>
		OpenCompose('<?php echo $this->_tpl_vars['CONSIGNMENT_NO']; ?>
','PurchaseOrder');
