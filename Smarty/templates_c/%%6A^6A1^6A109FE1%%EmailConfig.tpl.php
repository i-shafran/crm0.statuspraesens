<?php /* Smarty version 2.6.18, created on 2014-11-12 16:05:34
...
" alt="<?php echo $this->_tpl_vars['MOD']['LBL_MAIL_SERVER_SETTINGS']; ?>
" width="48" height="48" border=0 title="<?php echo $this->_tpl_vars['MOD']['LBL_MAIL_SERVER_SETTINGS']; ?>
"></td>
									...
									<tr>
										<td class="small" valign=top >
											<table width="100%"  border="0" cellspacing="0" cellpadding="5">
                                                    <tr>
                            <td nowrap class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_USE_SENDMAIL']; ?>
</strong></td>
                            <td class="small cellText">
				<?php if ($this->_tpl_vars['USE_SENDMAIL'] == 'checked'): ?>
...
&nbsp;</strong></td>
 ...
 id="server">
                          ...
                          <tr valign="top">
                            <td nowrap class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_OUTGOING_MAIL_SERVER_PORT']; ?>
</strong></td>
                            <td class="small cellText"><?php echo $this->_tpl_vars['MAILSERVERPORT']; ?>
&nbsp;</td>
                          </tr>
												<tr valign="top">
...
&nbsp;</td>
 ...
 id="from_email_field">
						  ...
						  <tr>
							<td nowrap class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_FROM_NAME']; ?>
</strong></td>
							<td class="small cellText"><?php echo $this->_tpl_vars['FROM_NAME']; ?>
&nbsp;</td>
							</td>
						  </tr>
												<tr>
 ...
 id="smtp_auth">
			...
			<tr>
                            <td nowrap class="small cellLabel"><strong><?php echo $this->_tpl_vars['MOD']['LBL_SSL_OPTIONS']; ?>
</strong></td>
                            <td class="small cellText">
				<?php if ($this->_tpl_vars['SSL'] == 'checked'): ?>
		    		    <?php echo $this->_tpl_vars['MOD']['LBL_SSL']; ?>

		    		<?php elseif ($this->_tpl_vars['TLS'] == 'checked'): ?>
				...
				<?php endif; ?>
                            ...
                            <td class="small cellText">
                              	<input type="checkbox" name="use_sendmail" <?php echo $this->_tpl_vars['USE_SENDMAIL']; ?>
/>
			    </td>
                        </tr>
                        														<tr>
...
" name="server" id="server">
                          ...
                          <tr valign="top">
                            ...
                            <td class="small cellText">
				<input type="text" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['MAILSERVERPORT']; ?>
" name="port">
			    </td>
                          </tr>
														<tr valign="top">
...
" name="from_email_field" id="from_email_field"/>
						...
						<tr>
							...
							<td class="small cellText">
				 <input type="text" class="detailedViewTextBox small" value="<?php echo $this->_tpl_vars['FROM_NAME']; ?>
" name="from_name"/>
							</td>
						</tr>
														<tr>
...
/>
			...
			<tr>
                            ...
                            <td class="small cellText">
		    		<input type="radio" name="server_tls" value="no" <?php echo $this->_tpl_vars['NOTLS']; ?>
 />&nbsp;<?php echo $this->_tpl_vars['MOD']['LBL_NO_TLS']; ?>

				<input type="radio" name="server_tls" value="tls" <?php echo $this->_tpl_vars['TLS']; ?>
 />&nbsp; <?php echo $this->_tpl_vars['MOD']['LBL_TLS']; ?>

				<input type="radio" name="server_tls" value="ssl" <?php echo $this->_tpl_vars['SSL']; ?>
 />&nbsp; <?php echo $this->_tpl_vars['MOD']['LBL_SSL']; ?>
 </td>
		       </tr>
													</table>
