<?php /* Smarty version 2.6.18, created on 2014-12-06 17:01:52
         compiled from modules/RecycleBin/RecycleBin.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'modules/RecycleBin/RecycleBin.tpl', 25, false),array('function', 'html_options', 'modules/RecycleBin/RecycleBin.tpl', 58, false),)), $this); ?>
...
"/> 
                                				<input type="button" onclick="$('rb_empty_conf_id').style.display='none';" value="<?php echo $this->_tpl_vars['MOD']['LBL_NO']; ?>
"/>
                                                                			</td>
		</tr>
	</tbody>
