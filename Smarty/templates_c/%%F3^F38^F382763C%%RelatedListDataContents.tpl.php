<?php /* Smarty version 2.6.18, created on 2014-08-18 09:21:22
...
?>
				                                   <td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><?php echo getTranslatedString($this->_tpl_vars['_RECORD_DATA']); ?>
</td>
                                                   			<?php endforeach; endif; unset($_from); ?>
		</tr>
	<?php endforeach; else: ?>
