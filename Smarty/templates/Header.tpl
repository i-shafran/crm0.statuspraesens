...
<TABLE border=0 cellspacing=0 cellpadding=0 width=100% class="small">
	<tr>
{* SalesPlatform.ru begin: prevent logo skew *}
            <td valign=center style="height: 4.2em;"><img src="test/logo/{$LOGO}" alt="{$LOGO}" title="{$LOGO}" border=0 style="max-width: 15em;max-height: 4.2em;"></td>
...
<div  id="usersettings" class="drop_mnu_user" onmouseout="fnHideDrop('usersettings');" onmouseover="fnvshNrm('usersettings');"  style="width:110px;left:1226px;">
	<table border=0 width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr >
			<td style="padding-left:0px;padding-right:10px font-weight:bold"  nowrap> <a href="http://community.salesplatform.ru/vtiger_links.php/wiki?version=540" target="_blank" class="drop_down_usersettings">{$APP.LNK_HELP}</a> </td>
        </tr>
        <tr >
			<td style="padding-left:0px;padding-right:10px font-weight:bold"  nowrap> <a href="http://community.salesplatform.ru/vtiger_links.php/community" target="_blank" class="drop_down_usersettings">{$APP.LNK_COMMUNITY}</a> </td>
        </tr>
	</table>
</div>
