...
<br>
	<div align=center>
			...
			<tr>
					<td width=50 rowspan=2 valign=top><img src="{'currency.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_CURRENCY_SETTINGS}" width="48" height="48" border=0 title="{$MOD.LBL_CURRENCY_SETTINGS}"></td>
