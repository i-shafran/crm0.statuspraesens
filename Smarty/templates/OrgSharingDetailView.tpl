...
<tbody><tr>
	...
	<div align=center>
			{include file="SetMenu.tpl"}
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'shareaccess.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_SHARING_ACCESS}" width="48" height="48" border=0 title="{$MOD.LBL_SHARING_ACCESS}"></td>
