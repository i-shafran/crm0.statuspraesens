				...
				<td width="50%" valign=top>
					<form name="install"  method="POST" action="index.php">
						...
						<table align="center" cellpadding="15" cellspacing="0" width="85%" class="mailClient importLeadUI small" border="0">
							<tr>
								<td colspan="2" valign="middle" align="left" class="mailClientBg genHeaderSmall">{$MOD.LBL_MODULE_NAME} {$MOD.LBL_INSTALL} {if $STEP neq 'error'}>> {$STEPNAME} >> {$CURRENT_STEP}/<span id="total_steps">{$TOTAL_STEPS}</span>{/if}</td>
								<br/>
							</tr>
							{if $STEP eq "1"}
							<tr>
							...
							<tr>
    							...
    							<table width="100%">
    							     <tr>
                                       ...
                                       <span class="genHeaderSmall">{$MOD.LBL_INSTALL_SUCCESS}</span>
  									   </td>
     								 </tr>
     								 {*<tr>
     								   <td align="left" valign="top" class="small" style="padding-left:40px;">   								    
