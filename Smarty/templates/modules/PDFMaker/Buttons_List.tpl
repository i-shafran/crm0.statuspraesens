	...
	<td width=100% nowrap>
			...
			<td>
				...
				<tr>
					{if $EDIT eq 'permitted'}
	                    <td style="padding-right:0px;padding-left:10px;"><a href="index.php?module=PDFMaker&action=EditPDFTemplate&return_action=DetailView&parenttab={$CATEGORY}"><img src="{$IMAGE_PATH}btnL3Add.gif" alt="{$MOD.LBL_ADD_TEMPLATE}" title="{$MOD.LBL_ADD_TEMPLATE}" border=0></a></td>
					{else}
		...
		<td class="small">
			...
			{* vtlib customization: Hook to enable import/export button for custom modules. Added CUSTOM_MODULE *}
	   		{if $IMPORT eq 'yes'}	
				<td style="padding-right:0px;padding-left:10px;"><a href="index.php?module=PDFMaker&action=ImportPDFTemplate&parenttab={$CATEGORY}"><img src="{$IMAGE_PATH}tbarImport.gif" alt="{$APP.LBL_IMPORT} {$MODULE|getTranslatedString:$MODULE}" title="{$APP.LBL_IMPORT} {$MODULE|getTranslatedString:$MODULE}" border="0"></a></td>	
			{else}	
		...
		<td class="small">
			<!-- All Menu -->
				...
				{if $CHECK.moduleSettings eq 'yes'}
	        		<td style="padding-left:10px;"><a href='index.php?module=Settings&action=ModuleManager&module_settings=true&formodule=PDFMaker&parenttab=Settings'><img src="{'settingsBox.png'|@vtiger_imageurl:$THEME}" alt="{$MODULE|getTranslatedString:$MODULE} {$APP.LBL_SETTINGS}" title="{$MODULE|getTranslatedString:$MODULE} {$APP.LBL_SETTINGS}" border="0"></a></td>
				{/if}
				</tr>
				</table>
		</td>			
