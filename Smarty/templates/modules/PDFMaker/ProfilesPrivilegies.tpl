        ...
        <table class="prvPrfOutline" border="0" cellpadding="10" cellspacing="0" width="100%">
            <tr><td>
                ...
                <table class="tableHeading" border="0" cellpadding="5" cellspacing="0" width="90%" style="margin:0 auto;">
                    <tr>
                        <td class="colHeader pm_colHeader" width="40%">{$MOD.LBL_PROFILES}</td>
                        <td class="colHeader pm_colHeader" width="15%" align="center">{$MOD.LBL_CREATE_EDIT}</td>
                        <td class="colHeader pm_colHeader" width="15%" align="center">{$MOD.LBL_VIEW}</td>
                        <td class="colHeader pm_colHeader" width="15%" align="center">{$MOD.LBL_DELETE}</td>
                        <td class="colHeader pm_colHeader" width="15%" align="center">{$MOD.LBL_EXPORT_TO_RTF}</td>
                    </tr>
                    ...
                    {foreach item=arr from=$PERMISSIONS}
                        {foreach key=profile_name item=profile_arr from=$arr}
                            <tr>
                                ...
                                <td class="cellText" align="center">
                                    <input type="checkbox" {$profile_arr.DETAIL.checked} id="{$profile_arr.DETAIL.name}" name="{$profile_arr.DETAIL.name}" onclick="view_chk_clicked(this, '{$profile_arr.EDIT.name}', '{$profile_arr.DELETE.name}',  '{$profile_arr.EXPORT_RTF.name}');"/>
                                </td>
                                <td class="cellText" align="center">
