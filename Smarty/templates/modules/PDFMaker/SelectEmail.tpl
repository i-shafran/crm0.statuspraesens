...
<div id="roleLay2" style="z-index:12;display:block;width:350px;" class="layerPopup">
	<table border=0 cellspacing=0 cellpadding=5 width=100% class=layerHeadingULine>
		<tr>
			<td width="90%" align="left" class="genHeaderSmall" id="sendpdfmail_cont_handle" style="cursor:move;">{$MOD.SELECT_EMAIL}
			...
			<td width="10%" align="right">
				<a href="javascript:fninvsh('roleLay2');"><img title="{$APP.LBL_CLOSE}" alt="{$APP.LBL_CLOSE}" src="{'close.gif'|@vtiger_imageurl:$THEME}" border="0"  align="absmiddle" /></a>
			</td>
		</tr>
	</table>
