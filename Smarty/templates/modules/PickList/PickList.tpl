...
<tbody><tr>
	...
	<div align=center>
		...
		<tr>
			<td width=50 rowspan=2 valign=top><img src="{'picklist.gif'|@vtiger_imageurl:$THEME}" width="48" height="48" border=0  alt="{$MOD.LBL_PICKLIST_EDITOR}" title="{$MOD.LBL_PICKLIST_EDITOR}"></td>
