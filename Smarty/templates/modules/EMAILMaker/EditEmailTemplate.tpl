	...
	<td> 
        ...
        <tr><td align="left" valign="top">
          ...
          <div style="diplay:block;" id="properties_div">       
            ...
            {* list view block *}
            <tr>
            	<td valign="top" class="small cellLabel"><strong>{$MOD.LBL_LISTVIEWBLOCK}:</strong></td>
            	<td valign="top" class="small cellText">
                 ...
                 <input type="button" value="{$MOD.LBL_INSERT_TO_TEXT}" class="crmButton small create" onclick="InsertIntoTemplate('listviewblocktpl');"/>
            	</td>
            </tr> 					
            ...
            <tr>
				...
				<td class="cellText small" valign=top>
					<select name="customfunction" id="customfunction" class="classname">
                       ...
                       <optgroup label="{$MOD.LBL_AFTER}">    
                           <option value="_AFTER|its4you_if|param1|comparator|param2|return1|return2">if-else</option>
                           <option value="_AFTER|its4you_unsubscribeemail|$accounts-crmid$|$contacts-crmid$|URL_ADDRESS|{$MOD.LBL_UNSUBSCRIBE_EMAIL}">{$MOD.LBL_UNSUBSCRIBE_EMAIL_LINK}</option>   
                           <option value="_AFTER|functionname|param1">{$MOD.CUSTOM_FUNCTION}</option>   
                       </optgroup>
                     </select>
          ...
          <div style="display:none;" id="settings_div">
			...
			<tr>
			   ...
			   <td class="cellText small" valign="top"><input type="text" name="email_category" value="{$EMAIL_CATEGORY}" class="detailedViewTextBox" style="width:200px;"/></td>
			</tr>
            {* default from setting *}
            <tr>
			   <td valign=top class="small cellLabel"><strong>{$MOD.LBL_DEFAULT_FROM}:</strong></td>
			   <td class="cellText small" valign="top">
               ...
               if (selectField == 'ORGANIZATION_STAMP_SIGNATURE')
      	       ...
      	       {ldelim}
                   ...
                   {ldelim}
                      ...
                      if(selectField.substr(0,6) == "_AFTER")
                          insert_value = '[CUSTOMFUNCTION'+selectField+'|CUSTOMFUNCTION_AFTER]'; 
                      else
...
function EditRelatedBlock()
{
    ...
    var popup_url = 'index.php?module=EMAILMaker&action=EMAILMakerAjax&file=ListRelatedBlocks&emailmodule='+email_module;
