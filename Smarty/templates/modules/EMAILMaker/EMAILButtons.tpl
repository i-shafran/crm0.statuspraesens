        ...
        <tr>
            ...
            <table class="small listTable" border="0" cellpadding="5" cellspacing="0" width="100%">
                ...
                <tr>
                      ...
                      <a href="javascript:void(0);" onclick="vtlib_toggleEmailModule('{$module.tabid}', '{$module.name}', '{if $module.link_type_a eq 'enabled'}disable{else}enable{/if}','a');"><img src="themes/images/{$module.link_type_a}.gif" alt="{if $module.link_type_a eq 'enabled'}Disable{else}Enable{/if} {$module.name}" title="{if $module.link_type_a eq 'enabled'}Disable{else}Enable{/if} {$module.name}" align="absmiddle" border="0"></a>
                      </td>
                      <td class="small cellText">
                      <a href="javascript:void(0);" onclick="vtlib_toggleEmailModule('{$module.tabid}', '{$module.name}', '{if $module.link_type_b eq 'enabled'}disable{else}enable{/if}','b');"><img src="themes/images/{$module.link_type_b}.gif" alt="{if $module.link_type_b eq 'enabled'}Disable{else}Enable{/if} {$module.name}" title="{if $module.link_type_b eq 'enabled'}Disable{else}Enable{/if} {$module.name}" align="absmiddle" border="0"></a>
                      </td>
