...
<head>
	...
	<script language="JavaScript" type="text/javascript" src="modules/EMAILMaker/EMAILMaker.js"></script>
</head>
		...
		<td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" > 
						<tr>
							...
							<td width="75%" valign="top"  bgcolor=white >
								...
								{include file='modules/EMAILMaker/BlockFilters.tpl'}
								</div>
								<!-- STEP 2 -->
								{literal}   
                ...
                {literal}   
                    <script type="text/javascript">
                    	CKEDITOR.replace('relatedblock',{customConfig:'../../../modules/EMAILMaker/fck_config.js'} );
                    </script>
                {/literal}
						</td>
					</tr>
