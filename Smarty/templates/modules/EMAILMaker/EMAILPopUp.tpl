	...
	new Ajax.Request(
		'index.php',
		{
			...
			onComplete: function(response){ 
                ...
                {
                    document.getElementById('process_title').innerHTML = "{/literal}{$MOD.LBL_EMAILS_SENDING_FAILED}{literal}";
                    
                    if (popupText != "")
                        document.getElementById('process_content').innerHTML = popupText;
                    else
                        document.getElementById('process_content').innerHTML = '<a href="index.php?'+url+'&debug=true">{/literal}{$MOD.LBL_CLICK_FOR_MORE_INFO}{literal}';
                }
                else
                {
