...
var templateid = eval({$task->att_template});
</script>
<script src="modules/com_vtiger_workflow/resources/emailtaskscript.js" type="text/javascript" charset="utf-8"></script>
<script src="modules/com_vtiger_workflow/resources/pdftemplateslist.js" type="text/javascript" charset="utf-8"></script>

<table border="0" cellpadding="5" cellspacing="0" width="100%" class="small">
	<tr>
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b><font color=red>*</font> {$MOD.LBL_EMAIL_RECEPIENT}</b></td>
	...
	<tr>
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b> {$MOD.LBL_EMAIL_CC}</b></td>
	...
	<tr>
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b> {$MOD.LBL_EMAIL_BCC}</b></td>
	...
	<tr>
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b><font color=red>*</font> {$MOD.LBL_EMAIL_SUBJECT}</b></td>
		<td class='dvtCellInfo'><input type="text" name="subject" value="{$task->subject}" id="save_subject" class="form_input"></td>
	</tr>
	<tr>
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b> {$MOD.LBL_EMAIL_PDF_ATTACHMENT}</b></td>
		<td class='dvtCellInfo'><input type="hidden" name="att_template" value="{$task->att_template}" id="save_att_template" class="form_input" style='width: 250px;'>
			<span id="task-emailfieldsattachment-busyicon"><b>{$MOD.LBL_LOADING}</b><img src="{'vtbusy.gif'|@vtiger_imageurl:$THEME}" border="0"></span>
			<select id="task-emailfieldsattachment" onchange="this.form.att_template.value=this.value" class="small" style="display: none;"><option value=''>{$MOD.LBL_SELECT_OPTION_DOTDOTDOT}</option></select></td>
	</tr>
</table>
