...
<br>
	<div align=center>
			{include file="SetMenu.tpl"}
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'proxy.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_PROXY_SERVER_SETTINGS}" width="48" height="48" border=0 title="{$MOD.LBL_PROXY_SERVER_SETTINGS}"></td>
