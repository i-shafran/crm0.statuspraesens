...
<br>
	<div align=center>
			...
			<tr>
				<td width="50" rowspan="2" valign="top"><img src="{'inventory.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.INVENTORYNOTIFICATION}" width="48" height="48" border=0 title="{$MOD.INVENTORYNOTIFICATION}"></td>
