...
<br>
			...
			{include file="SetMenu.tpl"}
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'backupserver.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_BACKUP_SERVER_SETTINGS}" width="48" height="48" border=0 title="{$MOD.LBL_BACKUP_SERVER_SETTINGS}"></td>
