...
<br>
	...
	<input type="hidden" name="action">
			{include file="SetMenu.tpl"}	
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'company.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_COMPANY_DETAILS}" width="48" height="48" border=0 title="{$MOD.LBL_COMPANY_DETAILS}"></td>
...
<!-- SalesPlatform.ru begin -->
                          ...
                          <tr>
                            <td class="small cellLabel"><strong>{$MOD.LBL_ORGANIZATION_KPP}</strong></td>
                            <td class="small cellText">{$ORGANIZATIONKPP}</td>
                          </tr>
                          <tr>
