			...
			{/if}
							...
							<div align=center>
								...
								<table border=0 cellspacing=0 cellpadding=5 width=100% class="settingsSelUITopLine">
									<tr>
					<td width=50 rowspan=2 valign=top><img src="{'ogmailserver.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_MAIL_SERVER_SETTINGS}" width="48" height="48" border=0 title="{$MOD.LBL_MAIL_SERVER_SETTINGS}"></td>
