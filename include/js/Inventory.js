...
// SalesPlatform.ru begin
//	coltwo.innerHTML= '<table border="0" cellpadding="1" cellspacing="0" width="100%"><tr><td class="small" id="viewproductcode"><input id="hdnProductcode'+count+'" name="hdnProductcode'+count+'" class="small" style="width: 70%;" value="" readonly="readonly" type="text"></td></tr><tr><td class="small"><input id="productName'+count+'" name="productName'+count+'" class="small" style="width: 70%;" value="" readonly="readonly" type="text">'+
