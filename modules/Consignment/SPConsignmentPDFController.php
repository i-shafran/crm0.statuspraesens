...
class SalesPlatform_ConsignmentPDFController extends SalesPlatform_PDF_ProductListDocumentPDFController{
	...
	function buildDocumentModel() {
		...
		if($this->focusColumnValue('salesorder_id')) {
                ...
                $entity = new Invoice();
		if($this->focusColumnValue('invoice_id')) {
            	    $entity->retrieve_entity_info($this->focusColumnValue('invoice_id'), 'Invoice');
		}
                $this->generateEntityModel($entity, 'Invoice', 'invoice_', $model);
