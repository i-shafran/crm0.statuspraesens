...
// SalesPlatform 5.2.1-20110824 to 5.3.0-201112
...
if(!in_array('bankaccount',$columnNames)){
        ExecuteQuery("ALTER TABLE vtiger_organizationdetails ADD COLUMN bankaccount VARCHAR(1024) default '' AFTER kpp");
}
...
$migrationlog->debug("\n\nDB Changes from 5.2.1-20110824 to 5.3.0-201112  -------- Ends \n\n");
