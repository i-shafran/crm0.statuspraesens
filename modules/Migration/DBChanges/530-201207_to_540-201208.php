...
$migrationlog->debug("\n\nDB Changes from 5.3.0-201207 to 5.4.0-201208 -------- Starts \n\n");
...
ExecuteQuery("update vtiger_tab set parent = 'Tools' where name = 'SPPDFTemplates'");
ExecuteQuery("update vtiger_tab set tabsequence = -1 where name = 'SPPDFTemplates'");
ExecuteQuery("update vtiger_tab set parent = null where name = 'SPModulePickList'");
ExecuteQuery("update vtiger_tab set tabsequence = -1 where name = 'SPModulePickList'");
ExecuteQuery("update vtiger_tab set parent = 'Sales' where name = 'Act'");
ExecuteQuery("update vtiger_tab set tabsequence = -1 where name = 'Act'");
ExecuteQuery("update vtiger_tab set parent = 'Sales' where name = 'Consignment'");
ExecuteQuery("update vtiger_tab set tabsequence = -1 where name = 'Consignment'");
...
$migrationlog->debug("\n\nDB Changes from 5.3.0-201207 to 5.4.0-201208 -------- Ends \n\n");
?>