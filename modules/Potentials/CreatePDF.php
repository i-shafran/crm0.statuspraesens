...
if(isset($_REQUEST['savemode']) && $_REQUEST['savemode'] == 'file') {
	...
	$filepath='test/product/'.$id.'_Potential.pdf';
	...
	$controller->Output('Potential.pdf', 'D');//added file name to make it work in IE, also forces the download giving the user the option to save
	exit();
}
