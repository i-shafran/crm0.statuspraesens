	...
	public static function runScheduledImport() {
		...
		foreach ($scheduledImports as $scheduledId => $importDataController) {
			...
			$importStatusCount = $importDataController->getImportStatusCount();
                        ...
                        $emailSubject = getTranslatedString('LBL_TITLE_SCHEDULED_IMPORT', 'Import').'['.getTranslatedString('LBL_MODULE_NAME', $importDataController->module).']';
			...
			$importResult = str_replace('align="center"', '', $importResult);
                        // SalesPlatform.ru begin localization for Import
                        $emailData = getTranslatedString('LBL_PROCESS_COMPLETED', 'Import').' <br/><br/>' .
							$importResult . '<br/><br/>'.
							getTranslatedString('LBL_CHECK_IMPORT', 'Import');
