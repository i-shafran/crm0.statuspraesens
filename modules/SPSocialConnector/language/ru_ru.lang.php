...
// for SPSocialConnectorSelectWizard.tpl
'Select URL'    =>  'Выбор URL',
'Please select the URL to send the message' =>  'Пожалуйста, выберите URL для отправки сообщения',

// for SPSocialConnectorComposeWizard.tpl
...
// Msg status   
'Vkontakte: message sent!'                  =>  'Вконтакте: сообщение отправлено!',
'Facebook: message sent!'                   =>  'Facebook: сообщение отправлено!',
'Twitter: message sent!'                    =>  'Twitter: сообщение отправлено!',
'Vkontakte: message was not sent!'          =>  'Вконтакте: сообщение не отправлено!',
'Facebook: message was not sent!'           =>  'Facebook: сообщение не отправлено!',
'Twitter: message was not sent!'            =>  'Twitter: сообщение не отправлено!',
