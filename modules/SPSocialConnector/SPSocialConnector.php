...
class SPSocialConnector extends CRMEntity {
    ...
    function vtlib_handler($modulename, $event_type) {
        ...
        if($event_type == 'module.postinstall') {
            ...
            $this->addSocialNet(array("1","Facebook","facebook.com"));
            $this->addSocialNet(array("2","Vkontakte","vk.com"));
            $this->addSocialNet(array("3","Twitter","twitter.com"));
            ...
            $adb->pquery("ALTER TABLE `vtiger_contactscf` ADD COLUMN `fb_url` VARCHAR(155) NULL ;", array());
            ...
            $adb->pquery("ALTER TABLE `vtiger_leadscf` ADD COLUMN `fb_url` VARCHAR(155) NULL ;", array());
            ...
            $adb->pquery("ALTER TABLE `vtiger_accountscf` ADD COLUMN `fb_url` VARCHAR(155) NULL ;", array());
