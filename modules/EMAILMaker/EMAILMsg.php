...
if(isset($_REQUEST['type']) && $_REQUEST['type'] == 'show')
{
    ...
    $messesage = $status."@<table  border='0' cellpadding='5' cellspacing='0'>
                          ...
                          $messesage .= $content;
                  if ($sent_emails != $total_emails) $messesage .= "<div style='text-align:center;padding:5px;'><a href='javascript:openPopUpForSent(".$esentid.");'>".$mod_strings["LBL_OPEN_EMAIL_POPUP"]."</a> (<a href='javascript:openWindowForSent(".$esentid.");'>".$mod_strings["LBL_OPEN_EMAIL_WINDOW"]."</a>)</div>";    
        	   	  $messesage .= "</td></tr>
        				  </table>";
