...
function openWindowForSent(esentid) 
{ 
    //window.location.href = 'index.php?module=EMAILMaker&action=EMAILMakerAjax&file=EMAILPopUp&esentid='+esentid,'sentemailWin'+esentid,420,300,'menubar=no,toolbar=no,location=no,status=no,resizable=yes,scrollbars=yes');

    window.location.href = 'index.php?module=EMAILMaker&action=processedEmails&esentid='+esentid;
