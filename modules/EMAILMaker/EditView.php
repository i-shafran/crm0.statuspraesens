...
$e_mod_strings = return_module_language($language, "Emails");
$em_mod_strings = return_module_language($language, "EMAILMaker");
...
elseif(isset($_REQUEST['sendmail']) && $_REQUEST['sendmail'] !='')
{
    ...
    else
    {
            ...
            */
            ...
            foreach ($Id_Lists AS $pid)
            {
                ...
                if ($type != "1")
                {
                    ...
                    $entityNames = getEntityName($pmodule, $pid);
                    $From_Sorce[$pid] = $entityNames[$pid];
                }
            }  
        ...
        else
        {
            ...
            {
                $entityNames = getEntityName($pmodule, $crmid);
                
                $To_Email[$crmid] = "";
                
                $From_Sorce[$crmid] = $entityNames[$crmid];       
            }
        }
    }
